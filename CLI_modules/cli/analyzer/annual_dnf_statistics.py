...
def run_annual_dnf_statistics(data_loader=None, f1_analysis_instance=None, show_detailed_output=True, **kwargs):
    """兼容接口：全部車手DNF分析 - 符合 function_mapper 調用"""
