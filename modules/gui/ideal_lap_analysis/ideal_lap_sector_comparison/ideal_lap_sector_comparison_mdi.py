...
try:
    ...
    from modules.gui.ideal_lap_analysis.ideal_lap_sector_comparison.ideal_lap_sector_comparison_data_loader import IdealLapSectorComparisonDataLoader
    # ✅ 測試: 使用新的表格版本
    from modules.gui.ideal_lap_analysis.ideal_lap_sector_comparison.ideal_lap_sector_comparison_table_widget import IdealLapSectorComparisonTableWidget as IdealLapSectorComparisonWidget
