...
class StraightLineSpeedDataLoader(UniversalDataLoader):
    ...
    def __init__(self, parent=None):
        ...
        self._api_worker: Optional[StraightLineSpeedApiWorker] = None  # ✅ API Worker 實例
    ...
    def _fetch_via_api_async(self, **kwargs):
        ...
        使用 StraightLineSpeedApiWorker 在背景執行緒執行 API 請求
        """
        try:
        ...
        # ✅ 創建並啟動 API Worker
        self._api_worker = StraightLineSpeedApiWorker(
            params,
            self._api_base_url,
            self._api_timeout
        )
