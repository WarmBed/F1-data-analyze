...
class CrossEventComparisonWorker(QThread):
    ...
    def run(self):
        try:
            ...
            print(f"[CROSS-EVENT-WORKER] 請求 API: {endpoint}")
            print(f"[CROSS-EVENT-WORKER] 參數: {query_params}")
            ...
            print(f"[CROSS-EVENT-WORKER] ❌ 請求失敗: {exc}")
            import traceback
            traceback.print_exc()
...
class GearAnalysisModule(IAnalysisModule):
    ...
    def load_data(self, **kwargs) -> bool:
        ...
        try:
            ...
            if self.data_manager:
                return self.data_manager.load_gear_data(
