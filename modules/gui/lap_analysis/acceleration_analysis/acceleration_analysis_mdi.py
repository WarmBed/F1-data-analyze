...
class CrossEventComparisonWorker(QThread):
    ...
    def run(self):
        try:
            ...
            print(f"[ACCELERATION-CROSS-EVENT-WORKER] 請求 API: {endpoint}")
            print(f"[ACCELERATION-CROSS-EVENT-WORKER] 參數: {query_params}")
            ...
            print(f"[ACCELERATION-CROSS-EVENT-WORKER] ❌ 請求失敗: {exc}")
            import traceback
            traceback.print_exc()
