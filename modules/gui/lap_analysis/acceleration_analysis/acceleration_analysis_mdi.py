...
class accelerationAnalysisModule(IAnalysisModule):
    ...
    def get_window_title(self, year: str = None, race: str = None, session: str = None, 
        ...
        print(f"[acceleration_TITLE_DEBUG]     - 年份: {use_year}")
        print(f"[acceleration_TITLE_DEBUG]     - 賽事: {use_race}")
        print(f"[acceleration_TITLE_DEBUG]     - 賽段: {use_session}")
        return title
    ...
    def update_lap_parameters(self, year: str, race: str, session: str, 
        ...
        try:
            ...
            if self.acceleration_chart_widget:
                ...
                print(f"[acceleration_MDI] ✅ 已設置時間軸模式: {use_time_axis}")
            ...
            if params_changed:
                ...
                print(f"[acceleration_MDI] ℹ️ 參數未變更，跳過數據重載")
                return True
