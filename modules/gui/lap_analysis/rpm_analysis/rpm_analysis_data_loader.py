...
class RPMAnalysisDataLoader(QObject):
    ...
    def load_rpm_data(self, year: int, race: str, session: str, 
        ...
        try:
            ...
            print(f"[RPM DEBUG] 分析模式: {'單車手' if driver2 is None else '雙車手對比'}")
    ...
    def _calculate_rpm_statistics_new(self, driver1_rpm: List[float], driver2_rpm: List[float], distance_data: List[float]) -> Dict[str, Any]:
        ...
        try:
            ...
            # 計算差值比較
            comparison = {
                'max_rpm_diff': driver1_stats['max_rpm'] - driver2_stats['max_rpm'],
                'avg_rpm_diff': driver1_stats['avg_rpm'] - driver2_stats['avg_rpm'],
                'min_rpm_diff': driver1_stats['min_rpm'] - driver2_stats['min_rpm'],
