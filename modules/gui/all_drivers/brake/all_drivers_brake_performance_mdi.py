...
try:
    ...
    from modules.gui.all_drivers.brake.brake_performance_loader import (
...
try:
    ...
    from modules.gui.all_drivers.brake.all_drivers_brake_performance_table_widget import (
