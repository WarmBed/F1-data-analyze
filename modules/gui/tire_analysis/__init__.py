...
# 主要模組匯出
try:
    from .tire_analysis_module import RainAnalysisModule
    from .tire_analysis_mdi import RainAnalysisUniversal, RainAnalysisDataManager
    from .tire_analysis_chart_widget import RainAnalysisChartWidget, RainChartTheme
    from .tire_data_loader import RainDataLoader, create_tire_data_loader
...
def create_tire_data_loader_instance(parent=None):
    ...
    if RainDataLoader is not None:
        return create_tire_data_loader(parent)
    else:
