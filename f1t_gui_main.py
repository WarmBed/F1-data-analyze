...
class StyleHMainWindow(QMainWindow):
    ...
    def rain_analysis(self, *args, **kwargs):
        """代理方法 - 委派給 RainAnalysisLauncher"""
        from windows.managers.rain_analysis_launcher import RainAnalysisLauncher
        if not hasattr(self, '_rain_analysis_launcher'):
            self._rain_analysis_launcher = RainAnalysisLauncher(self)
        return self._rain_analysis_launcher.rain_analysis(*args, **kwargs)
