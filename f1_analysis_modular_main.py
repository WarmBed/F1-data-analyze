...
class F1AnalysisModularCLI:
    ...
    def run_parameter_mode(self):
        ...
        # 125: 車輛性能綜合分析 (內部處理 FP2 數據載入)
        # 126: Live Timing 天氣分析 (使用 Live Timing API，不需 FastF1)
        ...
        data_optional_functions = {"49", "50", "51", "52", "55", "56", "57", "58", "70", "74", "75", "76", "81", "82", "83", "84", "85", "96", "98", "99", "100", "125", "126", "127", "143"}
